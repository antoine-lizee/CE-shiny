...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    textOutput("KT0Error"),
    tags$hr(),
    selectizeInput( "Filter1", "First Filter:", choices=c(list(NONE="NONE"), as.list(listOfFilters)), selected = "NONE"),
    uiOutput("FilterUI1"),
    tags$hr(),
    selectizeInput( "Filter2", "Second Filter:", choices=c(list(NONE="NONE"), as.list(listOfFilters)), selected = "NONE"),
    uiOutput("FilterUI2"),
    tags$hr(),
